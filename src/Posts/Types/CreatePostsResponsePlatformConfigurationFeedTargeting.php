...
class CreatePostsResponsePlatformConfigurationFeedTargeting extends JsonSerializableType
{
    /**
     * @var ?string $caption
     */
    ...
    /**
     * @var ?array<CreatePostsResponsePlatformConfigurationFeedTargetingMediaItem> $media
     */
    #[JsonProperty('media'), ArrayType([CreatePostsResponsePlatformConfigurationFeedTargetingMediaItem::class])]
    public ?array $media;

    /**
     * @var ?value-of<CreatePostsResponsePlatformConfigurationFeedTargetingPlacement> $placement
     */
     ...
     * @param array{
     *   caption?: ?string,
     *   media?: ?array<CreatePostsResponsePlatformConfigurationFeedTargetingMediaItem>,
     *   placement?: ?value-of<CreatePostsResponsePlatformConfigurationFeedTargetingPlacement>,
     *   location?: ?string,
