...
class CreatePostsResponsePlatformConfigurationExternalMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<CreatePostsResponsePlatformConfigurationExternalMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([CreatePostsResponsePlatformConfigurationExternalMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<CreatePostsResponsePlatformConfigurationExternalMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
