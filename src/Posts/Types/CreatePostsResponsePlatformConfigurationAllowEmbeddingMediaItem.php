...
class CreatePostsResponsePlatformConfigurationAllowEmbeddingMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<CreatePostsResponsePlatformConfigurationAllowEmbeddingMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([CreatePostsResponsePlatformConfigurationAllowEmbeddingMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<CreatePostsResponsePlatformConfigurationAllowEmbeddingMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
