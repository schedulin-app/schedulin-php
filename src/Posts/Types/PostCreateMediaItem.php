...
class PostCreateMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<PostCreateMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([PostCreateMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<PostCreateMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     *   name?: ?string,
     *   mimeType?: ?string,
