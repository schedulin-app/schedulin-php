...
class CreatePostsResponsePlatformConfigurationAllowlistedCountryCodesMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<CreatePostsResponsePlatformConfigurationAllowlistedCountryCodesMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([CreatePostsResponsePlatformConfigurationAllowlistedCountryCodesMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<CreatePostsResponsePlatformConfigurationAllowlistedCountryCodesMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
