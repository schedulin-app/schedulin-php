...
class CreatePostsResponsePlatformConfigurationCommunityIdMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<CreatePostsResponsePlatformConfigurationCommunityIdMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([CreatePostsResponsePlatformConfigurationCommunityIdMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<CreatePostsResponsePlatformConfigurationCommunityIdMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
