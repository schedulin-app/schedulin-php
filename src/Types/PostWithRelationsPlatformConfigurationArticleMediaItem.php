...
class PostWithRelationsPlatformConfigurationArticleMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<PostWithRelationsPlatformConfigurationArticleMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([PostWithRelationsPlatformConfigurationArticleMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<PostWithRelationsPlatformConfigurationArticleMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
