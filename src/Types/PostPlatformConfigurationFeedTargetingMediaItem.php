...
class PostPlatformConfigurationFeedTargetingMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<PostPlatformConfigurationFeedTargetingMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([PostPlatformConfigurationFeedTargetingMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<PostPlatformConfigurationFeedTargetingMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
