...
class PostPlatformConfigurationCommunityIdMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<PostPlatformConfigurationCommunityIdMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([PostPlatformConfigurationCommunityIdMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<PostPlatformConfigurationCommunityIdMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
