...
class PostPlatformConfigurationAllowComment extends JsonSerializableType
{
    /**
     * @var ?string $caption
     */
    ...
    /**
     * @var ?array<PostPlatformConfigurationAllowCommentMediaItem> $media
     */
    #[JsonProperty('media'), ArrayType([PostPlatformConfigurationAllowCommentMediaItem::class])]
    public ?array $media;
    ...
    /**
     * @var ?value-of<PostPlatformConfigurationAllowCommentPrivacyStatus> $privacyStatus
     */
     ...
     * @param array{
     *   caption?: ?string,
     *   media?: ?array<PostPlatformConfigurationAllowCommentMediaItem>,
     *   title?: ?string,
     *   description?: ?string,
     *   photoCoverIndex?: ?int,
     *   privacyStatus?: ?value-of<PostPlatformConfigurationAllowCommentPrivacyStatus>,
     *   allowComment?: ?bool,
     *   allowDuet?: ?bool,
     *   allowStitch?: ?bool,
