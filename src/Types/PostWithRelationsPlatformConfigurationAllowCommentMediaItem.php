...
class PostWithRelationsPlatformConfigurationAllowCommentMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<PostWithRelationsPlatformConfigurationAllowCommentMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([PostWithRelationsPlatformConfigurationAllowCommentMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<PostWithRelationsPlatformConfigurationAllowCommentMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
