...
class PostWithRelationsPlatformConfigurationExternalMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<PostWithRelationsPlatformConfigurationExternalMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([PostWithRelationsPlatformConfigurationExternalMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<PostWithRelationsPlatformConfigurationExternalMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
