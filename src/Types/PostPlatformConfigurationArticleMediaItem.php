...
class PostPlatformConfigurationArticleMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<PostPlatformConfigurationArticleMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([PostPlatformConfigurationArticleMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<PostPlatformConfigurationArticleMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
