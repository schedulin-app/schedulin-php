...
class PostPlatformConfigurationAllowEmbeddingMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<PostPlatformConfigurationAllowEmbeddingMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([PostPlatformConfigurationAllowEmbeddingMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<PostPlatformConfigurationAllowEmbeddingMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
