...
class PostWithRelationsPlatformConfigurationAllowComment extends JsonSerializableType
{
    /**
     * @var ?string $caption
     */
    ...
    /**
     * @var ?array<PostWithRelationsPlatformConfigurationAllowCommentMediaItem> $media
     */
    #[JsonProperty('media'), ArrayType([PostWithRelationsPlatformConfigurationAllowCommentMediaItem::class])]
    public ?array $media;
    ...
    /**
     * @var ?value-of<PostWithRelationsPlatformConfigurationAllowCommentPrivacyStatus> $privacyStatus
     */
     ...
     * @param array{
     *   caption?: ?string,
     *   media?: ?array<PostWithRelationsPlatformConfigurationAllowCommentMediaItem>,
     *   title?: ?string,
     *   description?: ?string,
     *   photoCoverIndex?: ?int,
     *   privacyStatus?: ?value-of<PostWithRelationsPlatformConfigurationAllowCommentPrivacyStatus>,
     *   allowComment?: ?bool,
     *   allowDuet?: ?bool,
     *   allowStitch?: ?bool,
