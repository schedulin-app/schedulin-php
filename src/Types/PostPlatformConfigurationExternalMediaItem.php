...
class PostPlatformConfigurationExternalMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<PostPlatformConfigurationExternalMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([PostPlatformConfigurationExternalMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<PostPlatformConfigurationExternalMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
