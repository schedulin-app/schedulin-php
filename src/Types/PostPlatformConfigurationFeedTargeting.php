...
class PostPlatformConfigurationFeedTargeting extends JsonSerializableType
{
    /**
     * @var ?string $caption
     */
    ...
    /**
     * @var ?array<PostPlatformConfigurationFeedTargetingMediaItem> $media
     */
    #[JsonProperty('media'), ArrayType([PostPlatformConfigurationFeedTargetingMediaItem::class])]
    public ?array $media;

    /**
     * @var ?value-of<PostPlatformConfigurationFeedTargetingPlacement> $placement
     */
     ...
     * @param array{
     *   caption?: ?string,
     *   media?: ?array<PostPlatformConfigurationFeedTargetingMediaItem>,
     *   placement?: ?value-of<PostPlatformConfigurationFeedTargetingPlacement>,
     *   location?: ?string,
