...
class PostWithRelationsPlatformConfigurationAllowEmbeddingMediaItem extends JsonSerializableType
{
    /**
     * @var string $url
     */
    ...
    /**
     * @var ?array<PostWithRelationsPlatformConfigurationAllowEmbeddingMediaItemTagsItem> $tags
     */
    #[JsonProperty('tags'), ArrayType([PostWithRelationsPlatformConfigurationAllowEmbeddingMediaItemTagsItem::class])]
    public ?array $tags;
     ...
     *   tags?: ?array<PostWithRelationsPlatformConfigurationAllowEmbeddingMediaItemTagsItem>,
     *   alt?: ?string,
     *   skipProcessing?: ?bool,
     * } $values
     */
